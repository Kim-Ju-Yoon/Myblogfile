...
<body>
  ...
  <!-- <button type="button" class="mobile-nav-toggle d-xl-none"><i class="bx bx-list-ul mobile-nav-toggle"></i></button> -->
  ...
  <header id="header" class="d-flex flex-column justify-content-center">
    ...
    <nav id="navbar" class="navbar nav-menu">
      <ul>
        <li><a href="#hero" class="nav-link scrollto active"><i class='bx bx-home-alt-2' ></i> <span>Home</span></a></li>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center">
    <div class="container" data-aos="zoom-in" data-aos-delay="100">
      <h1>Ju Yoon Kim</h1>
      <p>I'm <span class="typed" data-typed-items="front-end, back-end, full-stack, endeavor"></span></p>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-8 pt-4 pt-lg-0 content">
            ...
            <p class="fst-italic">
              프론트와 백엔드 둘다 같이 해낼 수 있는 풀스택 개발자가 되기 위해 노력하고 있습니다.
            </p>
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class='bx bxs-right-arrow'></i> <strong>Birthday:</strong> <span>10 October 1997</span></li>
                  <li><i class='bx bxs-right-arrow'></i> <strong>e-mail:</strong> <span>kj5841@naver.com</span></li>
                  <li><i class='bx bxs-right-arrow'></i> <strong>Phone:</strong> <span>010-3212-5841</span></li>
                  <li><i class='bx bxs-right-arrow'></i> <strong>City:</strong> <span>울산, 대한민국</span></li>
                </ul>
              </div>
              <div class="col-lg-6">
                <ul>
                  <li><i class='bx bxs-right-arrow'></i> <strong>Age:</strong> <span>27(97년생)</span></li>
                  <li><i class='bx bxs-right-arrow'></i> <strong>Degree:</strong> <span>취준생</span></li>
                  <li><i class='bx bxs-right-arrow'></i> <strong>hobby: </strong> <span>유투브,카페가기</span></li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row skills-content">
          ...
          <div class="col-lg-6">
            ...
            <div class="progress">
              <span class="skill">Spring <i class="val">40%</i></span>
              <div class="progress-bar-wrap">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            ...
            <div class="resume-item">
              <h4>문서작성 자격증 보유</h4>
              <p><em>개발자는 개발만 하는 것이 아니라 자신의 의견을 표출할 수 있어야 된다고 생각하기에 도움이 될것이라 생각합니다.</em></p>
              <ul>
                <li>ITQ한글(A)</li>
                <li>ITQ파워포인트(B)</li>
                <li>DIAT워드프로세서(고급)</li>
            ...
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <div class="portfolio-links">
                  <a href="resources/img/portfolio/BoardList.png" data-gallery="portfolioGallery" class="portfolio-lightbox" title="MVC 모델2로 게시판 기능구현"><i class="bx bx-plus"></i></a>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox-blue">
              ...
              <h4><a href="">티스토리</a></h4>
              <p>개발 공부를 해나가면서 공부한 내용을 포스팅 하여 올리면서 공부하고 있습니다.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box iconbox-orange ">
              ...
              <h4><a href="">깃허브</a></h4>
              <p>개발하면서 만든 코드들을  깃허브에 매일 커밋 하여 푸쉬하고 있습니다.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box iconbox-red">
              ...
              <h4><a href="">유투브</a></h4>
              <p>개발공부하면서 배운 내용들을 유투브로 정리해나갈 예정입니다.(추후 공유)</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box iconbox-teal">
              ...
              <p>개인  인스타그램 입니다. (개인 sns계정입니다. DM문의사절x)</p>
            </div>
          </div>
  ...
  <script src="resources/js/noframework.waypoints.js"></script>
